...
#define PLAY_TIME 60.0
#define REST_TIME 5.0
...
int StatusCheck::m_soccer_sub_mode = SOCCER_REST;
...
void StatusCheck::Check(CM730 &cm730)
{
    ...
    // Fußball-Modus anhalten
    if(m_soccer_sub_mode == SOCCER_END && m_is_started == 2)
    {
        printf("END SOCCER \n");
